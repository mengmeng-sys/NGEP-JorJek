    ...
    <ThreeColumnLayout>
      <div className="w-full max-w-2xl mx-auto">
        ...
        <button
          type="button"
          onClick={() => navigate(-1)}
          className="inline-flex items-center gap-1.5 text-xs font-bold text-gray-500 hover:text-[#FF4F00] transition-colors cursor-pointer bg-white border border-gray-200 rounded-xl px-3 py-1.5 shadow-2xs mb-4"
        >
        ...
        <div className="relative w-full">
          <div
            ...
            aria-hidden="true"
          >
            <h1 className="text-lg sm:text-xl font-black text-gray-900">Request a Session</h1>
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="bg-white border border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xs mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <Link
                        ...
                        className="font-bold text-gray-900 text-xs sm:text-sm hover:text-[#FF4F00] transition-colors truncate block"
                      >
                        {safeName}
                      </Link>
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <span className="bg-purple-50 text-[#8B5CF6] text-[9px] sm:text-[10px] uppercase font-bold px-1.5 sm:px-2 py-0.5 rounded border border-purple-100">
                          {role}
                        </span>
                  ...
                  <p className="text-[11px] sm:text-xs text-gray-500 mt-3 leading-relaxed">
                    You're requesting an in-person or online study session with{' '}
                    <span className="font-bold text-gray-700">{safeName}</span>. Propose a
                    time below and the mentor will confirm or suggest an alternative.
                  </p>
                </div>

                {/* Request Form */}
                <div className="bg-white border border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xs space-y-4 sm:space-y-5">
                  <div>
                        ...
                        <button
                          ...
                          className={`text-[11px] sm:text-xs px-2.5 py-1 rounded-lg font-bold transition-all cursor-pointer select-none ${
                            type === 'Coursework Help'
                              ? 'bg-[#FFF4F0] text-[#FF4F00] border border-orange-200'
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                    <div>
                      ...
                      <input
                        type="date"
                        className="w-full border border-gray-200 rounded-xl p-2.5 text-xs text-gray-700 outline-none focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] bg-[#FAFAFA] shadow-2xs"
                      />
                    </div>
                    <div>
                      <label className="block text-[11px] font-bold text-gray-900 uppercase tracking-wider mb-1.5">
                    ...
                    <div>
                      ...
                      <select className="w-full border border-gray-200 rounded-xl p-2.5 text-xs text-gray-700 outline-none focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] bg-[#FAFAFA] shadow-2xs cursor-pointer">
                  ...
                  <div className="pt-2 sm:pt-3 border-t border-gray-100 flex items-center justify-between gap-2">
