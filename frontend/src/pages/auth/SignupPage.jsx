...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FBFBFB] dark:bg-gray-950 flex flex-col justify-center items-center px-3.5 sm:px-6 py-6 sm:py-12 relative">
      ...
      <div className="w-full max-w-lg sm:max-w-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl sm:rounded-2xl shadow-xs p-6 sm:p-10">
        ...
        {!microsoftVerified ? (
          ...
          <form onSubmit={handleSignup} className="space-y-3.5 sm:space-y-4">
            ...
            <div>
              ...
              <input type="text" required value={username} onChange={(e) => setUsername(e.target.value)} placeholder="e.g. Srun Vireak" className="w-full bg-[#FAFAFA] dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs text-gray-900 dark:text-gray-100 outline-none focus:bg-white dark:focus:bg-gray-800 focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs" />
            </div>
            <div>
              ...
              <div className="relative">
                <input type={showPassword ? 'text' : 'password'} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Create strong password" className="w-full bg-[#FAFAFA] dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs text-gray-900 dark:text-gray-100 outline-none focus:bg-white dark:focus:bg-gray-800 focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs pr-14" />
            ...
            <div>
              ...
              <input type="number" min="1" max={maxGen} value={gen} onChange={(e) => { const val = e.target.value; if (val === '' || (Number(val) >= 1 && Number(val) <= maxGen)) setGen(val); }} placeholder={maxGen <= 1 ? "1" : `1 - ${maxGen}`} className="w-full bg-[#FAFAFA] dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs text-gray-900 dark:text-gray-100 outline-none focus:bg-white dark:focus:bg-gray-800 focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs" />
