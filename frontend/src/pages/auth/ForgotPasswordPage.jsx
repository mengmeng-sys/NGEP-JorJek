...
=======
          <p className="text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1 max-w-xs mx-auto leading-relaxed">
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
        ...
        {done ? (
<<<<<<< HEAD
          <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-900/30 rounded-xl p-4 sm:p-6 text-center">
...
=======
          <div className="bg-orange-50 dark:bg-orange-900/20/70 border border-orange-200 dark:border-orange-900/30 rounded-xl p-4 sm:p-6 text-center">
            <span className="text-3xl block">✓</span>
            <h3 className="text-xs sm:text-sm font-bold text-gray-900 dark:text-gray-100 mt-2.5">Password Reset Successfully</h3>
            <p className="text-[11px] sm:text-xs text-gray-600 dark:text-gray-400 dark:text-gray-500 mt-1.5 leading-relaxed">
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
...
=======
            <button type="button" onClick={handleMicrosoft} disabled={inProgress !== 'none'} className="w-full flex items-center justify-center gap-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-2.5 sm:py-3 text-xs font-bold text-gray-700 dark:text-gray-300 dark:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800/50 hover:border-gray-400 transition-all shadow-xs cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed">
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
...
=======
              <button type="button" onClick={() => navigate('/auth/login')} className="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:text-gray-200 dark:text-gray-300 transition-colors cursor-pointer">
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
...
<<<<<<< HEAD
                <input type={showPassword ? 'text' : 'password'} required value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="Enter new password" className="w-full bg-[#FAFAFA] dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs text-gray-900 dark:text-gray-100 outline-none focus:bg-white focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs pr-14" />
...
=======
                <input type={showPassword ? 'text' : 'password'} required value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="Enter new password" className="w-full bg-[#FAFAFA] dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs text-gray-900 dark:text-gray-100 outline-none focus:bg-white dark:bg-gray-900 focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs pr-14" />
...
=======
              <p className="text-[10px] font-bold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-1.5">Password Requirements</p>
              <div className="flex items-center gap-1.5">
                <span className={`text-[10px] font-bold ${passwordCriteria.minLength ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'}`}>{passwordCriteria.minLength ? '✓' : '○'}</span>
                <span className={`text-[10px] ${passwordCriteria.minLength ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400 dark:text-gray-500'}`}>At least 8 characters</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className={`text-[10px] font-bold ${passwordCriteria.hasUpper ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'}`}>{passwordCriteria.hasUpper ? '✓' : '○'}</span>
                <span className={`text-[10px] ${passwordCriteria.hasUpper ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400 dark:text-gray-500'}`}>One uppercase letter</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className={`text-[10px] font-bold ${passwordCriteria.hasNumber ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'}`}>{passwordCriteria.hasNumber ? '✓' : '○'}</span>
                <span className={`text-[10px] ${passwordCriteria.hasNumber ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400 dark:text-gray-500'}`}>One number</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className={`text-[10px] font-bold ${passwordCriteria.hasSpecial ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'}`}>{passwordCriteria.hasSpecial ? '✓' : '○'}</span>
                <span className={`text-[10px] ${passwordCriteria.hasSpecial ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400 dark:text-gray-500'}`}>One special character</span>
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
<<<<<<< HEAD
                <input type={showPassword ? 'text' : 'password'} required value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Re-enter new password" className={`w-full bg-[#FAFAFA] dark:bg-gray-800 border rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs text-gray-900 dark:text-gray-100 outline-none focus:bg-white focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs pr-14 ${confirmPassword && !doPasswordsMatch ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`} />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 text-xs font-bold p-1 cursor-pointer">
=======
                <input type={showPassword ? 'text' : 'password'} required value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Re-enter new password" className={`w-full bg-[#FAFAFA] dark:bg-gray-800 border rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs text-gray-900 dark:text-gray-100 outline-none focus:bg-white dark:bg-gray-900 focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs pr-14 ${confirmPassword && !doPasswordsMatch ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`} />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 dark:text-gray-300 dark:text-gray-600 text-xs font-bold p-1 cursor-pointer">
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
                  {showPassword ? 'Hide' : 'Show'}
                </button>
...
=======
              }} className="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:text-gray-200 dark:text-gray-300 transition-colors cursor-pointer">
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
