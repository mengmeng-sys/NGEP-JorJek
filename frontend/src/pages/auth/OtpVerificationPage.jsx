...
export default function OtpVerificationPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FBFBFB] dark:bg-gray-950 flex flex-col justify-center items-center px-4 sm:px-6 py-8 sm:py-12 relative">
      <div className="absolute top-4 sm:top-6 left-4 sm:left-6">
        <BackHomeArrow />
      </div>
      <div className="w-full max-w-sm sm:max-w-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl sm:rounded-2xl shadow-xs p-5 sm:p-8 text-center">

        <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-orange-50 dark:bg-orange-900/20 border border-orange-100 dark:border-orange-900/30 text-[#FF4F00] flex items-center justify-center mx-auto mb-3.5 sm:mb-4">
...
=======
        <p className="text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1 max-w-xs mx-auto leading-relaxed break-words">
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
          {isResetFlow
            ? 'Enter the 6-digit code we sent to:  '
            : 'We sent a 6-digit confirmation code to: <br/>'}
          <strong className="text-gray-900 dark:text-gray-100 font-semibold">{userEmail}</strong>
        </p>

        {(error || info) && (
          <p className={`text-[11px] sm:text-xs mt-3 rounded-lg px-3 py-2 border ${
            error
              ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 border-red-100'
              : 'text-emerald-700 bg-emerald-50 dark:bg-emerald-900/20 border-emerald-100 dark:border-emerald-900/30'
          }`}>
            {error || info}
          </p>
        )}
...
=======
                className="w-10 h-12 xs:w-11 xs:h-13 sm:w-12 sm:h-14 text-center text-base sm:text-lg font-black text-gray-900 dark:text-gray-100 bg-[#FAFAFA] dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-lg sm:rounded-xl outline-none focus:bg-white dark:bg-gray-900 focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs"
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
              />
            ))}
          </div>
...
=======
                    className="w-full bg-[#FAFAFA] dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs text-gray-900 dark:text-gray-100 outline-none focus:bg-white dark:bg-gray-900 focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all shadow-2xs pr-14"
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
                  />
                  <button
                    type="button"
...
=======
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 dark:text-gray-300 dark:text-gray-600 text-xs font-bold p-1 cursor-pointer"
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
                  >
                ...
                <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 mt-2.5 bg-[#FAFAFA] dark:bg-gray-800 p-2.5 sm:p-3 rounded-xl border border-gray-100 dark:border-gray-800 text-[10px] sm:text-[11px]">
                  <span className={`flex items-center gap-1.5 ${passwordCriteria.minLength ? 'text-emerald-600 dark:text-emerald-400 font-bold' : 'text-gray-400 dark:text-gray-500'}`}>
                    <span>{passwordCriteria.minLength ? '✓' : '○'}</span> Min 8 characters
                  </span>
                  <span className={`flex items-center gap-1.5 ${passwordCriteria.hasUpper ? 'text-emerald-600 dark:text-emerald-400 font-bold' : 'text-gray-400 dark:text-gray-500'}`}>
                    <span>{passwordCriteria.hasUpper ? '✓' : '○'}</span> Uppercase letter
                  </span>
                  <span className={`flex items-center gap-1.5 ${passwordCriteria.hasNumber ? 'text-emerald-600 dark:text-emerald-400 font-bold' : 'text-gray-400 dark:text-gray-500'}`}>
                    <span>{passwordCriteria.hasNumber ? '✓' : '○'}</span> At least 1 number
                  </span>
                  <span className={`flex items-center gap-1.5 ${passwordCriteria.hasSpecial ? 'text-emerald-600 dark:text-emerald-400 font-bold' : 'text-gray-400 dark:text-gray-500'}`}>
...
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
        ...
        <div className="mt-5 sm:mt-6 pt-5 border-t border-gray-100 dark:border-gray-800 flex flex-col xs:flex-row items-center justify-between gap-2 text-[11px] sm:text-xs">
...
=======
          className="text-xs font-semibold text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 dark:text-gray-300 dark:text-gray-600 transition-colors"
>>>>>>> 9489f93e3d75a63466e6f645e63fc574909f890b
        >
