  ...
  return (
    <ThreeColumnLayout>
      <div className="w-full space-y-3.5 sm:space-y-4">
        ...
        <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-sm border border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xs -mx-1 sm:mx-0 px-3 sm:px-5">
