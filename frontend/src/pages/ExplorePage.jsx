      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <section>
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h2 className="text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">
              Trending Tags
            </h2>
            <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium sm:hidden">Tap to filter</span>
          </div>

          {loading ? (
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-8 text-center text-xs text-gray-400 dark:text-gray-500">
              Loading campus tags...
            </div>
          ) : (
         ...
         <section>
           ...
           <div className="relative mb-4">
             ...
             <input
               ...
               placeholder="Search users by name..."
                className="w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl pl-9 pr-4 py-2.5 text-xs sm:text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 outline-none focus:border-[#FF4F00] focus:ring-1 focus:ring-[#FF4F00] transition-all"
             />
             {searchQuery && (
               <button
                 type="button"
                    ...
                    {searchResults.map((searchUser) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="mt-3 w-full border border-[#FF4F00] text-[#FF4F00] hover:bg-orange-50 active:bg-orange-100 text-[11px] font-bold py-1.5 rounded-lg transition-colors cursor-pointer"
                        >
                          View Profile
                        </button>
                      </div>
           ...
           <div className="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium">Swipe to browse →</span>
          </div>
          ...
          {/* Horizontal scroll container with native touch momentum & snap alignment */}
           <div className="flex gap-3 sm:gap-4 overflow-x-auto pb-4 pt-1 -mx-3 px-3 sm:-mx-4 sm:px-4 lg:mx-0 lg:px-0 scroll-smooth snap-x snap-mandatory">
             {suggestedMentors.length === 0 && !loading ? (
               <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-8 text-center text-xs text-gray-400 dark:text-gray-500 w-full">
                ...
                >
                  <div className="flex flex-col items-center w-full">
                    ...
                    {/* Name */}
                     ...
                     {/* Specialty */}
                     <p className="text-[11px] text-gray-400 dark:text-gray-500 mt-2 font-medium line-clamp-1 w-full" title={mentor.specialty}>
                       {mentor.specialty}
                     </p>
                  </div>
