        ...
        <section>
         ...
         <section>
           ...
           <div className="relative mb-4">
            ...
            {showResults && (
              <div className="bg-white border border-gray-200 rounded-xl shadow-lg mb-4 p-4">
                ...
                {searchLoading ? (
                  ...
                  <div className="py-8 text-center">
                    ...
                    <p className="text-xs text-gray-400 font-medium">No users found</p>
                    <p className="text-[10px] text-gray-300 mt-0.5">Try a different name</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                    {searchResults.map((searchUser) => (
                      <div
                        key={searchUser.id}
                        className="bg-white border border-gray-200 rounded-xl p-4 flex flex-col items-center text-center shadow-xs hover:border-gray-300 transition-all justify-between"
                      >
                        <div className="flex flex-col items-center w-full">
                          <UserAvatar initials={searchUser.initials} userId={searchUser.id} size="lg" className="mb-2.5 shadow-2xs" />
                          <h3 className="font-bold text-xs text-gray-900 leading-snug truncate w-full" title={searchUser.displayName || searchUser.name}>
                          ...
                          <p className="text-[11px] text-gray-400 mt-2 font-medium line-clamp-1 w-full" title={searchUser.specialty}>
