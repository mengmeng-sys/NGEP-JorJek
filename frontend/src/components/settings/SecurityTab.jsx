...
>>>>>>> Stashed changes
      ...
      <div className={`border rounded-xl p-4 flex items-center justify-between ${enabled ? "border-green-200 bg-green-50" : "border-gray-200 bg-gray-50"}`}>
        <div className="flex items-center gap-3">
          <div className={`w-8 h-8 rounded-full flex items-center justify-center ${enabled ? "bg-green-100" : "bg-gray-200"}`}>
            {enabled ? (
