  ...
  return (
    <div className="w-full">
      ...
      <div className="space-y-5 sm:space-y-6">
        {/* Avatar + Name */}
        <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-800/50/70 rounded-xl border border-gray-100 dark:border-gray-800">
        ...
        {user?.bio && (
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-relaxed bg-gray-50 dark:bg-gray-800/50/70 rounded-xl border border-gray-100 dark:border-gray-800 p-3.5">
              {user.bio}
            </p>
          </div>
        )}
        ...
        {(user?.gen || user?.department || user?.specialization) && (
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {user?.gen && (
                <span className="text-[11px] font-medium text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50/70 border border-gray-100 dark:border-gray-800 rounded-lg px-2.5 py-1.5">
                  Gen {user.gen}
                </span>
              )}
              {user?.department && (
        ...
        <div className="pt-4 border-t border-gray-100 dark:border-gray-800">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between py-2.5 px-3 bg-gray-50 dark:bg-gray-800/50/70 rounded-lg">
              <div className="flex items-center gap-2.5">
                <svg className="w-4 h-4 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-xs text-gray-500 dark:text-gray-400">University Email</span>
              </div>
              <span className="text-xs font-medium text-gray-700 dark:text-gray-300 truncate max-w-[200px]">{user?.email || '—'}</span>
            </div>
            <div className="flex items-center justify-between py-2.5 px-3 bg-gray-50 dark:bg-gray-800/50/70 rounded-lg">
              <div className="flex items-center gap-2.5">
                <svg className="w-4 h-4 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
