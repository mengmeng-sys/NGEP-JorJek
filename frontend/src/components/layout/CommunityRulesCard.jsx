...
export function CommunityRulesCard() {
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl sm:rounded-2xl overflow-hidden shadow-xs transition-all">
      {/* Header: Clickable on mobile to collapse/expand */}
      <div 
        onClick={() => setIsMobileExpanded(!isMobileExpanded)}
        className="flex items-center justify-between px-4 sm:px-5 py-3 sm:py-4 border-b border-gray-100 dark:border-gray-800 cursor-pointer lg:cursor-default select-none"
      >
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <h3 className="text-xs sm:text-sm font-bold text-gray-900 dark:text-gray-100 tracking-tight">
      ...
      <div className={`${isMobileExpanded ? 'block' : 'hidden'} lg:block divide-y divide-gray-100 dark:divide-gray-800`}>
        {rules.map((rule) => (
          <div 
            key={rule.number} 
            className="p-3 sm:p-4 flex items-start gap-2.5 sm:gap-3.5 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors"
          >
        ...
        {/* Footer Notice */}
        <div className="bg-gray-50/70 dark:bg-gray-800/50 p-3 sm:p-4 border-t border-gray-100 dark:border-gray-800 text-center">
