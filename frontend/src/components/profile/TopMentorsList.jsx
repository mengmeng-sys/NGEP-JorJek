  ...
  if (users.length === 0) {
    return (
      <div className="py-6 text-center">
        ...
        <p className="text-[11px] text-gray-400 dark:text-gray-500 font-medium">No top users yet</p>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <span className="text-[11px] text-gray-400 dark:text-gray-500 font-medium flex items-center gap-0.5">
