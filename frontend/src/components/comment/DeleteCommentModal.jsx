...
export function DeleteCommentModal({ isOpen, onClose, onConfirm, isReply = false }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1.5 leading-relaxed px-2">
